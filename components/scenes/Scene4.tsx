        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="lg:sticky lg:top-24">
            ...
            >
              ...
              <div className="h-2 w-24 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
            </motion.div>
          </div>
            ...
            <TracingBeam>
              <div className="space-y-16">
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -left-12 top-0 w-6 h-6 rounded-full bg-blue-500 border-4 border-slate-950" />

                  <div className="bg-gradient-to-br from-blue-950 to-slate-900 rounded-2xl p-8 border border-blue-900/50">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-blue-400 text-4xl">01</span>
                      <h3 className="text-3xl font-bold text-white">Labour Crisis</h3>
                    </div>
                    ...
                    <div className="space-y-4 text-gray-300">
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-6">
                        <div className="bg-red-950/30 rounded-xl p-4 border border-red-900/30">
                          ...
                          <div className="text-sm text-gray-400 mt-1">Chef shortage</div>
                        </div>
                        <div className="bg-red-950/30 rounded-xl p-4 border border-red-900/30">
                          <div className="text-3xl font-bold text-red-400">+70.8%</div>
                          <div className="text-sm text-gray-400 mt-1">Wage increase</div>
                        </div>
                      </div>
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -left-12 top-0 w-6 h-6 rounded-full bg-cyan-500 border-4 border-slate-950" />

                  <div className="bg-gradient-to-br from-cyan-950 to-slate-900 rounded-2xl p-8 border border-cyan-900/50">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-cyan-400 text-4xl">02</span>
                      <h3 className="text-3xl font-bold text-white">Supply Shock</h3>
                    </div>
                    ...
                    <div className="space-y-4 text-gray-300">
                      ...
                      <div className="space-y-3 mt-6">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-300">Meat</span>
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-gray-300">Dairy & Eggs</span>
                          <div className="flex items-center gap-2">
                            <div className="w-32 bg-gray-700 rounded-full h-3">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-gray-300">Vegetables</span>
                          <div className="flex items-center gap-2">
                            <div className="w-32 bg-gray-700 rounded-full h-3">
                              <div className="bg-orange-500 h-3 rounded-full" style={{ width: '30%' }} />
                            </div>
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -left-12 top-0 w-6 h-6 rounded-full bg-purple-500 border-4 border-slate-950" />

                  <div className="bg-gradient-to-br from-purple-950 to-slate-900 rounded-2xl p-8 border border-purple-900/50">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="text-purple-400 text-4xl">03</span>
                      <h3 className="text-3xl font-bold text-white">Admin Burden</h3>
                    </div>
                    ...
                    <div className="space-y-4 text-gray-300">
                      ...
                      <div className="bg-purple-950/30 rounded-xl p-6 border border-purple-900/30 mt-6">
                        <div className="text-center">
                          <div className="text-5xl font-bold text-purple-400 mb-2">+200%</div>
                          <div className="text-sm text-gray-400">Insurance Premium Increase</div>
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-4">
                        <div className="bg-slate-800 rounded-lg p-3 text-center">
                          <div className="text-sm text-gray-400">Employer Health Tax</div>
                          <div className="text-lg font-bold text-red-400">New (2019)</div>
                        </div>
                        <div className="bg-slate-800 rounded-lg p-3 text-center">
                          <div className="text-sm text-gray-400">Paid Sick Days</div>
